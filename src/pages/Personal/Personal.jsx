...
const Personal = () => {
  ...
  const loading = useSelector((state) => state.bookingReducer.booking);
            ...
            <div className={styles.user_info}>
              ...
              <div className={styles.details}>
                ...
                <div className={styles.description}>
                  Узнавай о новинках кино и специальных предложениях самым
                  первым! Еженедельно мы сообщаем о новинках кинопроката,
                  эксклюзивных показах, скидках и акциях.
                </div>
                <div>
